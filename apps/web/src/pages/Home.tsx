...
import { EMOTIONS, type Emotion } from "../types/types";
...
export default function Home() {
  ...
  const { todayProbabilities, dailySignal, labels } = useInsightStats(entries, HISTORY_DAYS);
  ...
  const todayDominant = useMemo(() =>
    getPrimaryEmotion(
      todayProbabilities,
      Object.fromEntries(
        EMOTIONS.map(emotion => [emotion, true]),
